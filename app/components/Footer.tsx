...
const Footer = () => {
  return (
    <>
      <footer className="relative z-10 px-6 sm:px-10 bg-white pt-20 pb-10 lg:pt-[120px]  lg:pb-20">
        <div className="container">
          <div className="flex flex-wrap -mx-4">
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="w-full mb-10">
                <Logo/>
                <p className=" text-[var(--main-text)] mb-7 ps-2 my-2 ">
            ...
            <div className="max-sm:text-center w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="w-full mb-10">
                <h4 className="text-lg font-semibold mb-9 text-[var(--footer-text)]">
                  Follow us On
                </h4>
                <div className="max-sm:justify-center flex items-center mb-6">
                  <a
                    href="/#"
                    className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-[var(--footer-text)] sm:mr-4 lg:mr-3 xl:mr-4"
                  >
                    <svg
                      width={8}
                      height={16}
...
const LinkGroup = ({ children, header } : {children : React.JSX.Element, header :string}) => {
  return (
    <>
      <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
        <div className="w-full mb-10">
          <h4 className="max-sm:text-center text-lg font-semibold mb-9 text-[var(--footer-text)]"> {header} </h4>
          <ul>{children}</ul>
        </div>
      </div>
    </>
  ...
  return (
    <div>
      <li>
        <a
          href={link}
          className={`max-sm:text-center max-sm:block inline-block mb-2 text-[var(--main-text)] leading-loose text-body-color hover:text-[var(--footer-text)] transition-all `}
        >
          {label}
        </a>
      </li>
